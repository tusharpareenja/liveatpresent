...
// For desktop
export const desktopHeaderPhrase = ["Introducing LAP's Next-", 'Gen Cards'];
export const desktopParagraphPhrase = [
  " Discover LAP's latest innovation – our new cards. Elevate your baoking",
  'experience with cutting-edge features, security, and unprecedented',
  'convenience.',
];

// For mobile
export const mobileHeaderPhrase = ["Introducing LAP's", 'Next-Gen Cards'];
export const mobileParagraphPhrase = [
  " Discover LAP's latest innovation – our new cards.",
  ' Elevate your booking experience with cutting-edge',
